...
import { dropdownFieldsByIdx, dropdownOptions, dropdownReverseMap } from '../dropdownMap/1A2_dropdownFieldMapping';
...
export default function Form1A2({ refreshTrigger }) {
    ...
    const fetchData = async (lang, pageNumber = page, limit = pageSize, filters = []) => {
        ...
        try {
            ...
            //const res = await axios.get(APP_API_URL + `/api/form1A2/getParticipantData?lang=${lang}&page=${pageNumber}&limit=${limit}`);
            const res = await axios.get(`${APP_API_URL}/api/form1A2/getParticipantData`, {
                params: {
                    lang,
                    page: pageNumber,
                    limit,
    ...
    const handleExcelExport = async () => {
        try {
            ...
            alert('Form 1A2 Export to Excel failed');
        } finally {
    ...
    const handleEditSubmissionAndParticipants = async () => {
        ...
        try {
            ...
            const response = await axios.post(APP_API_URL + `/api/form1A2/updateParticipantAndSubmissionData`, dataToSubmit); // Send the edited data object with new mapping
        ...
        <div onClick={() => setShowContextMenu(false)}>
            ...
            <div className="d-flex justify-content-between mb-2">
                <div className="d-flex align-items-center flex-wrap">
                    ...
                    {/* <button className='btn btn-primary btn-sm me-2 ' style={{ width: '120px' }} onClick={() => { setpageSize(20); }} title='To reload data from application database'>Refresh</button> */}
