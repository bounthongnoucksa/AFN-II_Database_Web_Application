...
export default function Form1A2({ refreshTrigger }) {
    ...
    const [pageSize, setpageSize] = useState(500); // limit the result to 100 records by default. if want to change this value then need to change on refresh button below as well.
