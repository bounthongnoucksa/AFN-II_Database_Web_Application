...
export default function Form3Act1a({ refreshTrigger }) {
    ...
    const [pageSize, setpageSize] = useState(100); // limit the result to 150 records by default. if want to change this value then need to change on refresh button below as well.
