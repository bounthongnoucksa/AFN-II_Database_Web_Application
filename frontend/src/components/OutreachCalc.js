                    ...
                    <table className="outreach-table table table-sm table-bordered align-middle text-center fs-7 ">
                        ...
                        <tbody >
                            ...
                            <tr>
                                ...
                                <td className="table-info" title='1A.1 & CB Villagers with Activity code (1A.1 + 1A.2 + 1A.4): Count all Participant HH-ID + Name'>{(reportData1A1[0]?.Count_cb_for_villagers_And_1A1_All_Participants || '0').toLocaleString()}</td>
                                <td>{ACTIVITY_OVERLAPS.fns}%</td>
                                <td className="table-info" title='1A.1 & CB Villagers with Activity code (1A.1 + 1A.2 + 1A.4): Count all Participant HH-ID + Name'>{(reportData1A1[0]?.Count_cb_for_villagers_And_1A1_All_Participants || '0').toLocaleString()}</td>
                                <td className="table-info" title='1A.1 & CB Villagers with Activity code (1A.1 + 1A.2 + 1A.4): Count unique number of HH-ID'>{(reportData1A1[0]?.Count_cb_for_villagers_And_1A1_Unique_HH_ID || '0').toLocaleString()}</td>
                                <td className="table-info" title='1A.1 & CB Villagers with Activity code (1A.1 + 1A.2 + 1A.4): (Count unique number of HH-ID) x 6'>{((reportData1A1[0]?.Count_cb_for_villagers_And_1A1_Unique_HH_ID || '0') * AVERAGE_HOUSEHOLD_SIZE).toLocaleString()}</td>
                            </tr>
