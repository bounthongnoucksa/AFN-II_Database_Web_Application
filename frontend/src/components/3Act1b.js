...
export default function Form3Act1b({ refreshTrigger }) {
    ...
    const [pageSize, setpageSize] = useState(800); // limit the result to 800 records by default. if want to change this value then need to change on refresh button below as well.
    ...
    const handleExcelExport = async () => {
        try {
            ...
            alert('Form 3Act1b Export to Export failed');
        }
    };
