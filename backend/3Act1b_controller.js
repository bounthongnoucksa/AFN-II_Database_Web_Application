        ...
        if (language === 'LA') {
            query = `
                ...
                SELECT
                    ...
                    (SELECT Label_Lao FROM Translation_EN_LA WHERE FormName='form_3act1b' AND ItemCode=np.Province LIMIT 1) AS 'ແຂວງ',
                    (SELECT Label_Lao FROM Translation_EN_LA WHERE FormName='form_3act1b' AND ItemCode=np.District LIMIT 1) AS 'ເມືອງ',
            ...
            query = `
                ...
                SELECT
                    ...
                    (SELECT Label_English FROM Translation_EN_LA WHERE FormName='form_3act1b' AND ItemCode=np.Province LIMIT 1) AS 'Province',
                    (SELECT Label_English FROM Translation_EN_LA WHERE FormName='form_3act1b' AND ItemCode=np.District LIMIT 1) AS 'District',
