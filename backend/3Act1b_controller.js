...
const KOBO_DOWNLOAD_SUBMISSION_API = `${process.env.KOBO_API_URL}/${KOBO_FORM_3Act1bFORM_ID}/data.json?limit=1000`; // KoboToolbox API endpoint for downloading submissions
...
function getForm3Act1bParticipantData(language, page, limit, filters = []) {
    return new Promise((resolve, reject) => {
        ...
        const countQuery = `SELECT COUNT(*) as total FROM tb_Form_3Act1b_Participant`;
