        ...
        if (language === 'LA') {
            query = `
                    ...
                    SELECT
                        ...
                        (SELECT Label_Lao FROM Translation_EN_LA WHERE FormName='form_1a2' AND ItemCode=np.Ethnicity LIMIT 1) AS 'ຊົນເຜົ່າ',
            ...
            query = `
                        ...
                        SELECT
                            ...
                            (SELECT Label_English FROM Translation_EN_LA WHERE FormName='form_1a2' AND ItemCode=np.Ethnicity LIMIT 1) AS 'Ethnicity',
