...
function getForm1A4ParticipantData(language) {
    return new Promise((resolve, reject) => {
        ...
        if (language === 'LA') {
            query = `
                    WITH NumberedParticipants AS (
                        ...
                        SELECT
                            ...
                            (SELECT Label_Lao FROM Translation_EN_LA WHERE FormName='form_1a4' AND ItemCode=np.Province LIMIT 1) AS 'ແຂວງ',
                            (SELECT Label_Lao FROM Translation_EN_LA WHERE FormName='form_1a4' AND ItemCode=np.District LIMIT 1) AS 'ເມືອງ',
                            (SELECT Label_Lao FROM Translation_EN_LA WHERE FormName='form_1a4' AND ItemCode=np.Village LIMIT 1) AS 'ບ້ານ',
                            ...
                            (SELECT Label_Lao FROM Translation_EN_LA WHERE FormName='form_1a4' AND ItemCode=np.Ethnicity LIMIT 1) AS 'ຊົນເຜົ່າ',
            ...
            query = `
                    ...
                    SELECT
                        ...
                        (SELECT Label_English FROM Translation_EN_LA WHERE FormName='form_1a4' AND ItemCode=np.Province LIMIT 1) AS 'Province',
                        (SELECT Label_English FROM Translation_EN_LA WHERE FormName='form_1a4' AND ItemCode=np.District LIMIT 1) AS 'District',
                        (SELECT Label_English FROM Translation_EN_LA WHERE FormName='form_1a4' AND ItemCode=np.Village LIMIT 1) AS 'Village',
                        ...
                        (SELECT Label_English FROM Translation_EN_LA WHERE FormName='form_1a4' AND ItemCode=np.Ethnicity LIMIT 1) AS 'Ethnicity',
